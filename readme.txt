...
Contributors: David Girard, Raphael Barbate
...
Publish your WordPress posts and pages to VideoSpot
...
**VideoSpot App Publisher** is very easy to install (instructions) :
* Upload the `/videospot-app-publisher` folder to your `/wp-content/plugins/` directory.
...
All futures requests are handled on [GitHub](https://github.com/Raphael Barbate/WordPressS2MemberFileBrowser/issues?sort=comments&state=open "GitHub")

== Translators ==

* French : Raphael Barbate

== Screenshots ==

1. The VideoSpot App Publisher button
2. Admin > The plugin configuration page

== Changelog ==

= 1.0.0 =
- Fix: some js would not be exported properly
